...
const translations = {
  en: {
    ...
    'menu.tira.name': 'Tiramisu Cups <span class="price">from $40</span>',
    'menu.tira.desc': 'Individual 2 oz cups — espresso-soaked ladyfingers under airy mascarpone cream, dusted with cocoa. Minimum order 12.',
    'menu.tira.s12': '12 cups (2 oz each)',
    'menu.tira.s18': '18 cups (2 oz each)',
    'menu.mou.name': 'Mousse Cups <span class="price">from $40</span>',
    'menu.mou.desc': 'Silky mousse over a tapioca or biscuit base, in five flavors. Minimum order 12 — mix and match as you like.',
    'menu.mou.f1': 'Mango Coconut',
    'menu.mou.f2': 'Strawberry',
    'menu.mou.f3': 'Blueberry + Milk Pudding',
    'menu.mou.f4': 'Sea Salt Oreo',
    'menu.mou.f5': 'Taro & Red Bean',
    'menu.mou.s12': '12 cups',
    'menu.mou.s18': '18 cups',
    'gal.tag': 'Gallery',
    ...
    'form.opt.tira': 'Tiramisu cups',
    'form.opt.mousse': 'Mousse cups',
  ...
  zh: {
    ...
    'menu.tira.name': '提拉米苏杯 <span class="price">$40 起</span>',
    'menu.tira.desc': '每杯 2 盎司——浓缩咖啡浸润的手指饼底，配轻盈马斯卡彭奶油，撒上可可粉。12 个起订。',
    'menu.tira.s12': '12 杯（每杯 2 盎司）',
    'menu.tira.s18': '18 杯（每杯 2 盎司）',
    'menu.mou.name': '慕斯杯 <span class="price">$40 起</span>',
    'menu.mou.desc': '丝滑慕斯，搭配西米或饼干底，共五种口味。12 个起订，口味可自由搭配。',
    'menu.mou.f1': '芒果椰香',
    'menu.mou.f2': '草莓',
    'menu.mou.f3': '蓝莓 + 牛奶布丁',
    'menu.mou.f4': '海盐奥利奥',
