...
const translations = {
  en: {
    ...
    'menu.cake.name': 'Custom Birthday Cakes <span class="price">from $48</span>',
    'menu.cake.desc': 'Two-layer organic sponge, naturally sweetened, decorated to your theme.',
    'menu.cake.s4': '4" — serves 4–6',
    'menu.cake.s6': '6" — serves 6–8',
    'menu.cake.s8': '8" — serves 12–16',
    'menu.cake.fruit': 'Add fresh seasonal fruit',
    'menu.cup.name': 'Cupcakes <span class="price">from $40</span>',
    'menu.cup.desc': 'Fluffy, lightly sweet, topped with whipped honey-buttercream — perfect for parties & favors.',
    ...
    'about.p2': 'I shop for our ingredients myself, and only at <strong>Whole Foods</strong>, <strong>Sprouts</strong>, and <strong>Bristol Farms</strong> — choosing organic, low-sugar foods I\'d happily feed my own family. Nothing else makes it into our kitchen.',
  ...
  zh: {
    ...
    'menu.cake.name': '定制生日蛋糕 <span class="price">$48 起</span>',
    'menu.cake.desc': '双层有机蛋糕，天然甜味，按您的主题装饰。',
    'menu.cake.s4': '4 英寸 — 适合 4–6 人',
    'menu.cake.s6': '6 英寸 — 适合 6–8 人',
    'menu.cake.s8': '8 英寸 — 适合 12–16 人',
    'menu.cake.fruit': '加新鲜时令水果',
    'menu.cup.name': '纸杯蛋糕 <span class="price">$40 起</span>',
    'menu.cup.desc': '蓬松、微甜，搭配蜂蜜黄油奶油——派对和伴手礼的完美选择。',
    ...
    'about.p2': '我亲自采购食材，只去 <strong>Whole Foods</strong>、<strong>Sprouts</strong> 和 <strong>Bristol Farms</strong>——选择我愿意给自己家人吃的有机、低糖食品。其他的，一律不进我的厨房。',
